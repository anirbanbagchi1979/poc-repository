 ...
 *
 * 1. query allIncidentsList by technician or customer
...
public class FiFTechnicianDC{
    ...
    private final String FIF_CUSTOM_API_INCIDENTS_URI = "/mobile/custom/incidentreport/incidents";
    ...
    private String mFifMobileBackendURL = null;
    ...
    private Diagnostics mFifDiagnostics = null;
    ...
    private ArrayList<Incident> allIncidentsList = new ArrayList<Incident>();
    ...
    public void setAllIncidents(ArrayList<Incident> incidents) {
        ...
        providerChangeSupport.fireProviderRefresh("allIncidentsList");
    ...
    public void filterIncidentListInMemory(String filterValue){
        ...
        if(filterValue .equalsIgnoreCase("ALL")){                
            ...
            this.allIncidentsList = new ArrayList<Incident>();
            this.allIncidentsList.addAll(this.mIncidentListCache);
        }
        ...
        //Loop over the list of incidents and remove all incident reports that have a status not matching the filter criteria
            ...
            AppLogger.logFine("List size BEFORE aplying filter: "+allIncidentsList.size() , this.getClass().getSimpleName(), "filterIncidentListInMemory");  
            //reset the content of all incidents
            ...
            this.allIncidentsList = new ArrayList<Incident>(tempList);
            AppLogger.logFine("List size AFTER aplying filter: "+allIncidentsList.size() , this.getClass().getSimpleName(), "_filterIncidentListInMemory");                         
        }
     ...
     */
     private List<Incident> _getIncidentByIdFromMCS(String incidentId){
         ...
         RequestContext request = new RequestContext();
         request.setConnectionName(REST_CONNECTION_NAME);
         request.setHttpMethod(oracle.mobile.cloud.sample.fif.technician.maf.RequestContext.HttpMethod.GET);
    ...
    private void _initMobileBackend() {
        ...
        mFifDiagnostics = new Diagnostics(mFifMobileBackend);
    ...
    private boolean _initFormAplicationPreferences(){
        ...
        //fifMobileBackendURL - required
        mFifMobileBackendURL = (String) AdfmfJavaUtilities.getELValue("#{preferenceScope.application.mcs.fifMobileBackendURL}");
        if(mFifMobileBackendURL == null){
            errors.add("FIF Mobile Backend URL");
        }

        FiFLogger.logFine("FIF Mobile Backend URL: "+mFifMobileBackendURL, this.getClass().getSimpleName(), "initFromPreferences()");
    ...
    */
    private void _qryIncidentsFromMcsForTechnician(String technician){
        ...
        this.allIncidentsList = this._getIncidentsFromMcsWithFilter(null, technician, this._getCurrentGeoPosition());
       
        //save a copy
        this.mIncidentListCache = new ArrayList<Incident>();
        this.mIncidentListCache.addAll(this.allIncidentsList);
    ...
    /**
     * /**
     * Queries the allIncidentsList in MCS by filter of contact (incident reportee) and technician. Note that one of the "contact" or "technician"
