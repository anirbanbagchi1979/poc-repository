...
public class AuthenticationHandler {
    ...
    public void setUserAuthenticated(boolean userAuthenticated) {
        ...
        propertyChangeSupport.firePropertyChange("userAuthenticated", oldUserAuthenticated, userAuthenticated);
    }
    ...
    public String login(){  
        ...
        boolean authenticationSuccess = performOauthAuthentication(this.getUsername(), this.getPassword());
                        
        if(authenticationSuccess){
            this.setUserAuthenticated(true);
            AppLogger.logFine("OAUTH Login Success for user "+this.getUsername(), this.getClass().getSimpleName(), "login");
    ...
    private void updateDataControlWithOauthToken(String _username, String _oauthtoken, String _tokenType){
             ...
             paramValues.add(_tokenType+" "+_oauthtoken);
             paramTypes.add(String.class);
